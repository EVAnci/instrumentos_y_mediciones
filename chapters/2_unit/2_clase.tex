...
\]
Esta relación hiperbólica (Fig. \ref{fig:error_en_funcion_alcance}) demuestra que medir en el inicio de la escala conlleva errores relativos enormes.

\input{chapters/2_unit/media/lineal.tex}
...
\input{chapters/2_unit/media/no_lineales.tex}
