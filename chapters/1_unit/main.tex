...
La comprensión plena de las deducciones requiere nociones previas sobre el flujo eléctrico, el potencial eléctrico y conceptos relacionados a la electrostática. Un desarrollo extenso de estos principios físicos fundamentales, así como de las leyes que rigen el campo eléctrico, se encuentra disponible en el recurso complementario \citetitle{f2elio} \parencite{f2elio}.
...
\begin{tcolorbox}[
  ...
  \tcblower
  \centering
  \input{chapters/1_unit/media/flujo_electrico.tex}
...
\input{chapters/1_unit/media/movimiento_de_cargas.tex}
...
\input{chapters/1_unit/media/corriente_convencional.tex}
...
\end{itemize}
\begin{tcolorbox}[
  colback=red!5!white,colframe=red!75!black!66,title=La Sobretensión Inductiva
  ]
...
\begin{description}
  ...
  \item[Intensidad de Campo Eléctrico (\(E\))]
