...
\begin{enumerate}
  ...
  \item Precisión: La repetibilidad de las lecturas en el mismo. Así, un instrumento puede ser muy preciso pero poco exacto si las medidas tienen alta tasa de repetibilidad pero, son lejanas del valor real. Sin embargo, todo instrumento exacto es preciso.
