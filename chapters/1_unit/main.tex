...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}[>=stealth]
    ...
    \shade[inner color=white!80!red, outer color=orange!50!red!70!lightgray] (-0.4,0.4) node{\footnotesize\textbf{+}} circle (.2) [radius=1pt];
    \draw[very thick,color=red!70!gray,->] (-0.1,0.4) node[above right=3pt] {\(v_d\)}-- (0.4,0.4) ;
    \shade[inner color=white!80!red, outer color=orange!50!red!70!lightgray] (-0.5,-0.3) node{\footnotesize\textbf{+}} node[below left=4pt] {\(q\)} circle (.2) [radius=1pt];
    \draw[very thick,color=red!70!gray,->] (-0.2,-0.3) -- (0.3,-0.3);
  \end{tikzpicture}
