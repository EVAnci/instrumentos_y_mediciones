...
Para determinar la ecuación que gobierna la deflexión de la aguja, retomamos el equilibrio de cuplas estudiado en el Capítulo 1. El sistema alcanzará el reposo cuando la Cupla Motora ($C_m$) iguale a la Cupla Antagónica ($C_r$).
