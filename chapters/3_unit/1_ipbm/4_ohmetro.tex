...
Si dividimos la ecuación general por la corriente máxima ($I_{max} = E/R_i$), obtenemos la deflexión relativa $F$:
\[
  F = \frac{I}{I_{max}} = \frac{\frac{E}{R_i+R_x}}{\frac{E}{R_i}} = \frac{R_i}{R_i + R_x} = \frac{1}{1 + \frac{R_x}{R_i}}
\]
...
\[ I_{max} = \frac{4.5}{4500} = \qty{1}{\milli\ampere} \]
...
Es fundamental incluir un interruptor (normalmente un pulsador) para no descargar la batería, ya que al no medir nada ($R_x = \infty$) el circuito consume corriente máxima.
